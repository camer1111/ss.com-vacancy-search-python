...
To start using this application, follow these simple steps. No technical knowledge required.

### 💻 System Requirements

- Windows, macOS, or Linux operating system
- Python 3.6 or higher installed on your computer
- An active internet connection to access job listings
- Optional: a text editor to view the output (e.g., Notepad, VS Code)
...
After you have installed the application, follow these steps to run it:
...
2. Navigate to the directory where you extracted the application files. You can do this by using the `cd` command followed by the path to your folder. For example:
   - `cd C:\path\to\your\folder` (Windows)
...
5. Once you complete the prompts, the application will gather job postings related to your search. It may take a few moments to collect the data.

6. The results will be saved in a CSV file in the same directory. You can open this file using any spreadsheet application, such as Microsoft Excel or Google Sheets.
...
- **Internet Connection Issues:** The application requires an active internet connection to fetch job postings. Verify your connection.

### 📚 Further Support

For additional help or to report issues, you can visit the discussion section of this repository. Your questions and feedback are always welcomed.
